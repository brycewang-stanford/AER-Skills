...
| [`replication-package-skeleton/`](replication-package-skeleton/) | A deposit-ready directory layout with AEA-compliant README, master script, globals file, and [`docs/exhibit-register.md`](replication-package-skeleton/docs/exhibit-register.md). Drop-in starting point for your own openICPSR submission |
