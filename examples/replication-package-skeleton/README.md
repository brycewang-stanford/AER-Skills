...
| `data/codebook/` | Variable dictionaries, source metadata, and crosswalk notes. |
| `docs/` | Data-use agreements, provenance notes, appendices, or other supporting documentation. |
