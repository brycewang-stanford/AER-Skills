.PHONY: preflight validate validate-strict skillopt-gate audit-skills audit-skills-gate verify-citations verify-citations-online install-codex install-claude scaffold-stata scaffold-r scaffold-python scaffold-skeleton
